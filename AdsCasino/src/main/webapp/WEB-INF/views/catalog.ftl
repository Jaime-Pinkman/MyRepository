    ...
    function showCatalog() {
        $.ajax({
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                table += "<img class=\"d-block w-100\" src='";
                table += data[i].product.image;
                table += "'>";
                table += "</li>";
            }
            table += "</ul>";
    ...
    <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" style="color: #6d7fcc">log in</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" onclick="showCatalog()" class="btn btn-light"><h4>Ad</h4></button>
